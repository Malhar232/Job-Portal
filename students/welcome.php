...
<html>
    ...
    <body>
        <?php  
            echo "<a href='../util/changePass.php'></a>";  
            $get_user_details="select * from students WHERE StudentEmail='{$_SESSION['email']}'";
            ...
            if( mysqli_num_rows($q_getUser)==0 ){
                ...
                echo "<ul id='slide-out' class='side-nav fixed z-depth-2'>
                    <li class='no-padding'>
                      ...
                      <div class='darken-2 white-text' style='height: 300px;padding-top:20px;  background-color: #7840a1 !important;'>
                        ...
                        <div class='row' style='line-height:30px'>
                          ...
                          <p style='margin:0;padding:0;font-weight:bold;font-size:1.1rem;text-align:justify'>
                            <i class='fa fa-user'></i> <span class='tag'>{$row['StudentName']}</span> <br> <i class='fa fa-building-o'></i> <span class='tag'>{$row['StudentCollege']}</span> <br> <i class='fa fa-calendar'></i> <span class='tag'>{$row['DOB']}</span>
                          </p>
                          </div>
                        </div>
                      </div>
                ...
                // echo "<a href='../util/updateProfile.php'>Update Profile</a>"; 
                // echo "<br><a href='CollegeDrive.php'>College Campus Placement Drive</a><br>";  
                // echo "<a href='jobsApplied.php'>Jobs Applied</a><br>";  
        ...
        <section class='main-section'>
            ...
            <div class="wrapper-count">
                ...
                <div class="counter col_fourth">
                    ...
                    <h2 class="timer count-title count-number" data-to="<?=mysqli_num_rows($q_get_clg_students)?>" data-speed="1000"></h2>
                    <p class="count-text ">Students from <?=$row['StudentCollege']?></p>
                </div>
                <div class="counter col_fourth">
            ...
            <script>
                ...
                var myChart = new Chart(ctx, {
                  ...
                  datasets: [{
                    ...
                    label: 'Registered students with us',
                ...
                options: {
                    ...
                    title: {
                      display: true,
                      text: 'Registered students with us',
                    },
                    animation: {
                      animateScale: true,
                      animateRotate: true
