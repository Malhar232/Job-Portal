...
<?php
    $campus_details="select * from campusdrive";
        ...
        ";
          ?>
<h1>Campus Drive</h1>
<a class="add" href='newDrive.php'>
<i class='fas fa-plus'></i> <span>Add Campus Drive</span>
</a>
<br>
<br>
    ...
    <tbody>
        <?php
            if( mysqli_num_rows( $q_campus_details )==0 ){
              echo '<tr><td colspan="15">No Campus Drives</td></tr>';
            }else{
            
              while( $college_campus_row = mysqli_fetch_assoc( $q_campus_details ) ){
                $applied_students="select * from jobapplications WHERE CompanyName='{$college_campus_row['CompanyName']}' AND StudentCollege='{$college_campus_row['CollegeName']}'";
                $q_applied_students=mysqli_query($connection,$applied_students);
                ...
                <td><a href='DriveApplications.php?q={$college_campus_row['CompanyName']}&c={$college_campus_row['CollegeName']}'>";
                echo mysqli_num_rows($q_applied_students)."</a></td>
                <td><a href='editDrive.php?q={$college_campus_row['CompanyName']}&c={$college_campus_row['CollegeName']}'> <img class='action' src='../images/icons/edit.png' width='18px'></a> <a href='DeleteDrive.php?q={$college_campus_row['CompanyName']}&c={$college_campus_row['CollegeName']}'> <img class='action' src='../images/icons/delete.png' width='18px'></a></td>
                </tr>\n";
